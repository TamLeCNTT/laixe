              ...
              <div className="row">
                <div className="col-12 col-md-6">
                  <div class="carousel-caption">
                    ...
                    <p>
                      Chúng tôi đã đảm bảo bạn sẽ được hỗ trợ. Khám phá những
                      dịch vụ kiểm tra đường của chúng tôi ngay.
                      <FaceBook />
                    </p>
              ...
              <div className="row">
                <div className="col-12 col-md-6">
                  <div class="carousel-caption">
                    ...
                    <p>
                      Học những mục tiêu quan trọng sẽ giúp bạn biến việc lái xe
                      trở thành một phần tự nhiên.
                    </p>
                    <div class="wrap-btn-slider">
                      <button class="btn-slider">
                        <svg
              ...
              <div className="row">
                <div className="col-12 col-md-6">
                  <div class="carousel-caption col-12 col-md-6">
                    ...
                    <p>
                      Các bài học của trường lái xe sẽ dẫn bạn trên con đường
                      với sự tự tin.
                    </p>
                    <div class="wrap-btn-slider">
                      <button class="btn-slider">
            ...
            <div class="row">
              <div class="col col-12 col-md-4">
                ...
                <h2 class="advance-title">
                  "An toàn và tự tin trên đường, chương trình dạy lái xe riêng
                  cho bạn."
                </h2>
              ...
              <div class="col col-12 col-md-4">
                <p class="advance-text">
                  Trước hết và quan trọng nhất, đảm bảo lái xe an toàn luôn được
                  đặt lên hàng đầu ưu tiên của chúng tôi.Trung tâm Hưng Thịnh tự
                  hào là trường lái xe hàng đầu tại Sóc Trăng, cung cấp các khóa
                  học lái xe chất lượng, tiện lợi và phải chăng để giúp bạn đạt
                  được bằng lái xe một cách suôn sẻ nhất. Hơn nữa, các hướng dẫn
                  viên có kinh nghiệm và kiên nhẫn của chúng tôi sẽ truyền đạt
                  cho bạn mọi kiến thức cần thiết để bạn có thể lái xe an toàn
                  và tự tin trên đường. Hãy khám phá cùng chúng tôi cách chúng
                  ta có thể cùng nhau lái xe an toàn hơn và hướng tới tương lai!
                </p>
              ...
              <div class="col col-12 col-md-4">
                <div class="testimonials-block">
                  ...
                  <p>
                    ...
                    professionalism thanks to each one I am from union city Nj
                    and I contacted your very professional and responsible
                    school I contacted them by email and they were very kind and
                    professional as well as responsible (Abdel) gave ...
                  </p>
                  <div class="testimonials-author">
                    <div class="testimonials-author-img">
                      <img src={author_1} alt="author 1" />
                    </div>
